        ...
        init : function(ed, url) {
            ...
            ed.onBeforeSetContent.add(function(ed, o) {
                ...
                while((running == true) && (o.content.indexOf(startTag) != -1)){
                    ...
                    if(endPos != -1){
                        ...
                        o.content = o.content.substr(0, startPos) + "<span style=\"color: red; font-weight: bold;\">[PHP]<!--CODE" + encodedPHPCode + "CODE--></span>" + o.content.substr(endPos + endTag.length);
                    } else {
                        running = false;
                    }
                }
            ...
            ed.onPostProcess.add(function(ed, o) {
                if (o.get) {
                    ...
                    var startTag = "<span style=\"color: red; font-weight: bold;\">[PHP]<!--CODE";
