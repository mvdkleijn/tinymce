            ...
            ed.onBeforeSetContent.add(function(ed, o) {
				...
				while((running == true) && (o.content.indexOf(startTag) != -1)){
					...
					if(endPos != -1){
						...
						o.content = o.content.substr(0, startPos) + "<span style=\"background-color: #a22; color: #fff;\" class=\"tinyPHPCode\">{PHP}<!--CODE" + encodedPHPCode + "CODE--></span>" + o.content.substr(endPos + endTag.length);
					} else {
						running = false;
					}
				}
