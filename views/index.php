<h1><?php echo __('TinyMCE plugin - Preferences');?></h1>
    ...
    <fieldset style="padding: 0.5em;">
        ...
        <table class="fieldset" cellpadding="0" cellspacing="0" border="0">
            <tr>
                ...
                <td class="field"><input name="listpublished" type="checkbox" disabled="disabled" <?php echo ($listpublished ? 'checked="true"' : ''); ?>/></td>
            ...
            <tr>
                ...
                <td class="field"><input name="listhidden" type="checkbox" <?php echo ($listhidden ? 'checked="true"' : ''); ?>/></td>
    ...
    <fieldset style="padding: 0.5em;">
        ...
        <table class="fieldset" cellpadding="0" cellspacing="0" border="0">
            <tr>
                ...
                <td class="field"><input name="imagesdir" type="text" size="35" maxsize="255" value="<?php echo $imagesdir;?>"/></td>
    ...
    <fieldset style="padding: 0.5em;">
        ...
        <table class="fieldset" cellpadding="0" cellspacing="0" border="0">
            <tr>
                ...
                <td class="field"><input name="cssuri" type="text" size="35" maxsize="255" value="<?php echo $cssuri;?>"/></td>
