...
<p>
<?php echo __('Apart from the normal TinyMCE usage, a few special features have been implemented which are described here in more detail.');?>
</p>
...
<p><?php echo __('In the popup that appears: '); ?></p>
<ul style="list-style: square inside none; font-size: 0.8em;">
<li><?php echo __('Below the "Image URL" box where you would normally type in the URL to the image, you will find a "Image list" dropdown box.');?></li>
...
<p>
<?php echo __('If the default setup of TinyMCE which this plugin provides does not suit your need, you can change it by editing the tinymce_init.php file. You can find this file in the root of the TinyMCE plugin\'s directory.');?>
</p>
